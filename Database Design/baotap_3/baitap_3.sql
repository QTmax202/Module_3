...
Insert Into NHACUNGCAnhacungcapP (MaNhaCC, TenNhaCC, DiaChi, SoDT, MaSoThue)
...
select distinct N.* 
from dongxe D
inner join dangkycungcap DC on D.DongXe = DC.DongXe
...
or (D.HangXe = 'Kia' and M.DonGia = 20000);
 ...
 -- 
SELECT dangkycungcap.MaNhaCC , nhacungcap.TenNhaCC , COUNT(*) AS 'so lan dang ky'
FROM `baitap_3`.dangkycungcap , `baitap_3`.nhacungcap
where dangkycungcap.MaNhaCC = nhacungcap.MaNhaCC and dangkycungcap.NgayBatDauCungCap >= '2015/11/20'
group by dangkycungcap.MaNhaCC , nhacungcap.TenNhaCC;
-- 
